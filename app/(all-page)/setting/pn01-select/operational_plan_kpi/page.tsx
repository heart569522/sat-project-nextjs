...
const TITLE = 'แก้ไขตัวชี้วัดแผนปฏิบัติการ';

export const metadata: Metadata = {
  title: TITLE,
};

export default async function OperationalPlanKPI() {
  const data = await getAllData('pn01-select-list/operational_plan_kpi_list');
