...
function EditInvoiceForm(_a) {
    ...
    var _e = react_dom_1.useFormState(updateInvoiceWithId, initialState), state = _e[0], dispatch = _e[1];
        ...
        React.createElement("div", { className: "rounded-md bg-gray-50 p-4 md:p-6" },
            React.createElement("div", { className: "mb-4" },
                ...
                React.createElement("div", { className: "relative" },
                    React.createElement("select", { id: "customer", name: "customerId", className: "peer block w-full cursor-pointer rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500", defaultValue: invoice.customer_id, "aria-describedby": "customer-error" },
            ...
            React.createElement("div", { className: "mb-4" },
                ...
                React.createElement("div", { className: "relative mt-2 rounded-md" },
                    React.createElement("div", { className: "relative" },
                        React.createElement("input", { id: "amount", name: "amount", type: "number", defaultValue: invoice.amount, step: "0.01", placeholder: "Enter USD amount", className: "peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500", "aria-describedby": "amount-error" }),
                ...
                React.createElement("div", { className: "rounded-md border border-gray-200 bg-white px-[14px] py-3" },
                    React.createElement("div", { className: "flex gap-4" },
                        React.createElement("div", { className: "flex items-center" },
                            React.createElement("input", { id: "pending", name: "status", type: "radio", value: "pending", defaultChecked: invoice.status === 'pending', className: "h-4 w-4 border-gray-300 bg-gray-100 text-gray-600 focus:ring-2" }),
                        ...
                        React.createElement("div", { className: "flex items-center" },
                            React.createElement("input", { id: "paid", name: "status", type: "radio", value: "paid", defaultChecked: invoice.status === 'paid', className: "h-4 w-4 border-gray-300 bg-gray-100 text-gray-600 focus:ring-2" }),
            ...
            React.createElement("div", { "aria-live": "polite", "aria-atomic": "true" }, state.message ? (React.createElement("p", { className: "my-2 text-sm text-red-500" }, state.message)) : null)),
