        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, api_service_1.fetchPages('project-proposal/fetch-page', query)];
                case 1:
                    totalPages = _b.sent();
                    console.log('🚀 ~ totalPages:', totalPages);
                    return [2 /*return*/, (React.createElement("div", { className: "w-full" },
                            React.createElement("div", { className: "flex text-xl md:text-2xl" }, "\u0E42\u0E04\u0E23\u0E07\u0E01\u0E32\u0E23/\u0E01\u0E34\u0E08\u0E01\u0E23\u0E23\u0E21"),
                            React.createElement("div", { className: "mt-4" },
                                React.createElement("div", { className: "flex items-center justify-between gap-2 md:mt-8" },
                                    React.createElement(buttons_1.CreateRequestProjectProposal, null),
                                    React.createElement(search_auto_1["default"], { placeholder: "\u0E04\u0E49\u0E19\u0E2B\u0E32\u0E42\u0E04\u0E23\u0E07\u0E01\u0E32\u0E23/\u0E01\u0E34\u0E08\u0E01\u0E23\u0E23\u0E21" })),
